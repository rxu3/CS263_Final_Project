...
#
	'''
	CREATE TABLE STATUS_EMPLOYER_CERTIFIED AS SELECT EMPLOYER_NAME , COUNT(CASE_NUMBER) AS CERTIFIED_NUMBER FROM H1B_16 WHERE CASE_STATUS = 'CERTIFIED' GROUP BY EMPLOYER_NAME;
	''',
	'''
